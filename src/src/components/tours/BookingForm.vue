<template>
  <section class="box ui-card" aria-label="Booking form">
    ...
    <form class="form" @submit.prevent="onSubmit" novalidate>
      <label class="field">
        ...
        <input class="ui-input" v-model.trim="form.fullName" type="text" autocomplete="name" />
        <span v-if="errors.fullName" class="error">{{ errors.fullName }}</span>
      </label>

      <label class="field">
        <span class="label">{{ $t('booking.phone') }}</span>
        <input class="ui-input" v-model.trim="form.phone" type="tel" inputmode="tel" autocomplete="tel" />
      ...
      <label class="field">
        ...
        <select class="ui-input" v-model.number="form.people">
      ...
      <label class="field field--full">
        ...
        <textarea class="ui-textarea" v-model.trim="form.note" rows="4"></textarea>
      </label>

      <button class="ui-btn ui-btn--primary btn" type="submit" :disabled="submitting">
